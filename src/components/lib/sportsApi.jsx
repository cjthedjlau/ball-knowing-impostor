...
const DIFFICULTY_CONFIG = {
  easy:          { teamsPerLeague: 3,  playersPerTeam: 5   },
  medium:        { teamsPerLeague: 5,  playersPerTeam: 12  },
  hard:          { teamsPerLeague: 8,  playersPerTeam: 20  },
  ballknowledge: { teamsPerLeague: 12, playersPerTeam: 999 },
};
